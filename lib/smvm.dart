...
class _SmvmScreenState extends State<SmvmScreen> {
  ...
  Future<void> _fetchData({DateTime? date, bool fetchLatest = false}) async {
    ...
    try {
            final response = await http.get(Uri.parse('https://api.allorigins.win/raw?url=https://infra.datos.gob.ar/catalog/sspm/dataset/57/distribution/57.1/download/indice-salario-minimo-vital-movil-valores-mensuales-pesos-corrientes-desde-1988.csv'));
